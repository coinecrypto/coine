...
static const int64 nTargetTimespan = 4 * 24 * 60 * 60; // FooCoin: 4 days
static const int64 nTargetSpacing = 240; // FooCoin: 4 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x81bf84eac833e424454e7880f3129b0712938564c31ac366b798b701c1422619");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Flight delayed after woman tosses coins into engine";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1498621298; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 120937;

        if (fTestNet)
        {
            block.nTime    = 1498621298;
            block.nNonce   = 120937;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0a8ca2177f782e3343f031e1ae858d9e08b5cc331582ad3bf9dcdd0a613497cb"));
